...
consulting the [API reference](https://pub.dev/documentation/riverpod/latest/all/all-library.html).
...
In some situations, you may want your Widget tree to push a route or show
